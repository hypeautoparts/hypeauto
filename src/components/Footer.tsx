...
const Footer = () => {
  const footerLinks = {
    ...
    products: [
      { name: 'Interior Parts', href: '/shop' },
      { name: 'Exterior Parts', href: '/shop' },
      { name: 'Body Parts', href: '/shop' },
    ...
    <footer className="bg-card/50 border-t border-border/50">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+18882349140" className="text-foreground hover:text-primary transition-colors">+1 (888) 234-9140</a>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-black text-lg mb-4 text-foreground">Products</h3>
            <ul className="space-y-3">
