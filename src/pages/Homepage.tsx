          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid md:grid-cols-3 gap-8 items-center text-center">
              <div className="animate-slide-up group cursor-pointer">
                ...
                <a href="tel:+18882349140" className="text-primary-foreground/90 hover:text-primary-foreground transition-colors text-lg font-semibold group-hover:animate-pulse">
                  +1 (888) 234-9140
                </a>
              </div>
